...
export function CategoryStory({ copy }: { copy: PortfolioCopy }) {
  return (
    <section id="categories" className="px-5 py-24 sm:px-8 md:py-36 lg:px-12">
      <div className="portfolio-enter mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.85fr_1.15fr]">
